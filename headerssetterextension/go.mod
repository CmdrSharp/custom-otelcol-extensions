module github.com/CmdrSharp/custom-otelcol-extensions/headerssetterextension
...
require (
	...
	go.opentelemetry.io/collector/extension/auth v0.97.1-0.20240404121116-4f1a8936d26b
